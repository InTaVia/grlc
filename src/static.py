...
DEFAULT_ENDPOINT_USER = os.environ.get("GRLC_DEFAULT_ENDPOINT_USER", config.get('defaults', 'user'))
DEFAULT_ENDPOINT_PASSWORD = os.environ.get("GRLC_DEFAULT_ENDPOINT_PASSWORD", config.get('defaults', 'password'))
